...
export default {
    ...
    callback: async ({ client, msg, prefix, args, Group }) => {
        ...
        let str =
            ...
            `* Source : https://github.com/ghost-king-tz/SPECTRA-V1-.git\n` +
        ...
        if (msg.isGroup) 
            str += `\n\n―――――――――――――――\n` +
                   ...
                   `👥 *Total Members:* ${msg.groupMetadata.participants.length}\n` + 
        ...
        const templateButtons = [
            { index: 1, urlButton: { displayText: `${botname}`, url: link_group } },
